...
HipoSchema::HipoSchema() {
    ...
    alertAhdcADCSchema.parse("sector/B, layer/B, component/S, order/B, ADC/I, time/F, ped/S, integral/I, timestamp/L, leadingEdgeTime/F, constantFractionTime/F, timeOverThreshold/F, mctime/F, mcEtot/F, nsteps/I");
